...
public class OrdersService implements OrderUseCase {
	...
	public Long createOrder(Order order) {
		...
		if (order==null || order.getNumber() != null) {
			throw new IllegalStateException("The order number must be null");
		}
		order.setNumber("Prueba"); // the order number is generated by the database.
		//order.setNumber(String.valueOf(h2Port.getNextOrderNumber())); // the order number is generated by the database.
	...
	public Long getNextOrderNumber() {
		return h2Port.getNextOrderNumber();
	}
}
